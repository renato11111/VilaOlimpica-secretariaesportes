...
<script>
    $(document).ready(function(){
        $('#cadatleta').validate({
            ...
            messages: {
                arquivo: {
                    required:"O campo de Imagem é obrigatorio"
                },
                nome_atleta:{
...
<title>Cadastrar - Vila Olimpica</title>
<main>
    <div class="container">
        <div>
          <p class="text-capitalize text-center font-weight-bold" style="font-size:32px;">Cadastrar Atletas</p>
        </div>

        <form name="cadatleta" id="cadatleta" action="processoCad.php" method="post" enctype="multipart/form-data">
            <div class="form-row">
                <div class="form-group col-md-6">
                    <div class="custom-file">
                        <input type="file" name="arquivo" class="custom-file-input" id="File" required>
                        <label class="custom-file-label" for="File">Escolher uma imagem:</label>
                    </div>
                </div>
            </div>
            <hr>
            <div class="form-row">
                <div class="form-group col-md-3">
                    ...
                    <input type="text" name="nome_atleta" class="form-control text-capitalize" id="inputNome1" placeholder="Digite um Nome completo " required>
                </div>

                <div class="form-group col-md-2">
                    <label for="inputData1">Data de Nascimento: </label>
                    <input type="text" name="data_nascimento" class="form-control" id="inputData1" required>
                </div>

                <div class="form-group col-md-2">
                    <label for="inputCpf1">CPF:</label>
                    <input type="text" name="cpf" class="form-control" id="inputCpf1" placeholder="000.000.000-00" required>
                </div>

                <div class="form-group col-md-2">
                    <label for="inputRG">RG:</label>
                    <input type="text" name="rg" class="form-control" id="inputRG" placeholder="00.000.000" required>
                </div>
                            
                <div class="form-group col-md-2">
                    <label for="inputExpedidor">Órgão expedidor:</label>
                    <select name="orgao_expedidor" id="inputExpedidor" class="form-control" required>
                ...
                <div class="form-group col-md-2.8">
                    ...
                    <input type="text" name="naturalidade" class="form-control text-capitalize" id="inputNaturalidade" placeholder="Digite sua cidade Natal" required>
                </div>

                <div class="form-group col-md-4">
                    <label for="inputEscola">Escola/Universidade:</label>
                        <input type="text" name="escola" class="form-control text-uppercase" id="inputEscola" placeholder="Digite onde o Atleta estuda ou estudou" required>
                </div>
            </div>
                ...
                <div class="form-row">
                    ...
                    <input type="text" name="nome_mae" class="form-control text-capitalize" id="inputmae" placeholder="Digite um Nome completo" required>
                </div>

                <div class="form-group col-md-4 ">
                    <label for="inputPai">Nome do Pai:</label>
                    <input type="text" name="nome_pai" class="form-control text-capitalize" id="inputPai" placeholder="Digite um Nome completo" required>
                </div>

                <div class="form-group col-md-4 ">
                    <label for="inputTel">Telefone do Responsável:</label>
                    <input type="text" name="tel_responsavel" class="form-control" id="inputTel" placeholder="(99) 9 9999-9999" required>
                </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <input type="text" name="endereco" class="form-control text-capitalize" id="inputAddress2" placeholder="Digite um Endereço" required>
                </div>

                <div class="form-group col-md-4">
                    <label for="inputBairro">Bairro:</label>
                    <input type="text" name="bairro" class="form-control text-capitalize" id="inputBairro" placeholder="Digite um Bairro" required>
                </div>

                <div class="form-group col-md-1.9">
                    <label for="inputNumero">N°:</label>
                    <input type="text" name="numero" class="form-control" id="inputNumero" placeholder="Digite um Númeral" required>
                </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <input type="text" name="cidade" class="form-control text-capitalize" id="inputCity" placeholder="Digite uma Cidade" required>
                </div>
                ...
                <div class="form-row">
                    ...
                    <input type="text" name="local_treinamento" class="form-control" id="inputTreino" placeholder="Digite onde o Atleta treina" required>
                </div>

                <div class="form-group col-md-5">
                    <label for="inputProfessor">Professor:</label>
                    <input type="text" name="professor" class="form-control text-capitalize" id="inputProfessor" placeholder="Digite o Nome do Professor (Treinador)" required>
                </div>
                </div>
                        
                <button type="submit" name="CadUser" id="CadUser" class="btn btn-success btn-lg btn-block">Finalizar cadastro</button>
        </form>
    </div>    
</main>
